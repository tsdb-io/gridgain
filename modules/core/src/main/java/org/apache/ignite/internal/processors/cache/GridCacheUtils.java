...
public class GridCacheUtils {
     ...
     */
    public static Map<Class<? extends EntryCompressionConfiguration>, Class<? extends EntryCompressionStrategy>>
        entryCompressionStrategies(GridKernalContext kernalCtx) {
        Map<Class<? extends EntryCompressionConfiguration>, Class<? extends EntryCompressionStrategy>> strategies =
            new HashMap<>();
