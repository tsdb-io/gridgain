 ...
 */
public interface EntryCompressionStrategy<T extends EntryCompressionConfiguration> extends AutoCloseable {
    /**
     ...
     *
     * @param compressionCfg Strategy configuration.
     * @param ctx Kernal context.
     * @param ccfg Cache configuration.
     */
    void start(T compressionCfg, GridKernalContext ctx, CacheConfiguration ccfg);
}
